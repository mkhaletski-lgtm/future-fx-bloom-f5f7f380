      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <p className="text-xs text-muted-foreground max-w-4xl mx-auto">
            Дисклеймер: Сайт prossfx.ru не является форекс-брокером и не предоставляет услуги торговли на финансовых рынках. Торговля на Форекс сопряжена с высокими рисками и может привести к потере капитала. Прошлые результаты не гарантируют будущих доходов. Всегда оценивайте свои риски.
          </p>
        </motion.div>
      </div>
    </footer>
